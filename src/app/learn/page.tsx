...
export const metadata: Metadata = {
  title: "Learn — A Level Physics Practice",
  description: "Study and practice for A Level Physics. Choose your subject and start preparing.",
};
