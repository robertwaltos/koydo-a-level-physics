...
export const metadata: Metadata = {
  title: "Pricing — A Level Physics Premium",
  description: "Unlock unlimited A Level Physics practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=a-level-physics&cadence=annual`;
